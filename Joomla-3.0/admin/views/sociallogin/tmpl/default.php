...
<form action="<?php echo JRoute::_('index.php?option=com_sociallogin&view=sociallogin&layout=default'); ?>" method="post" id="adminForm">
	...
	<fieldset class="social_login_form">
		<legend>Enter an URL to a CSS stylesheet to be used by Social Login:</legend>
		<div class="social_login_form_row social_login_form_row_even">
